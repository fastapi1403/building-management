...
const fa = {
    ...
    "owners": {
        "title": "مالکین",
        "add": "افزودن مالک جدید",
        "addNew": "افزودن مالک جدید",
        "edit": "ویرایش مالک",
        "delete": "حذف مالک",
        "view": "مشاهده مالک",
        "formName": "نام مالک",
        "formNumber": "شماره مالک",
        "formUnits": "تعداد کل واحدها",
        "formDescription": "توضیحات",
        "formSave": "ذخیره",
        "formCancel": "انصراف",
        "required": "الزامی است",
        "validationError": "خطای اعتبارسنجی",
        "validationNumber": "شماره مالک باید بزرگتر از 0 باشد",
        "validationUnits": "تعداد واحدها باید بزرگتر از 0 باشد",
        "deleteConfirmation": "آیا از حذف این مالک مطمئن هستید؟",
        "deleteConfirmButton": "بله، حذف شود!",
        "restore": "بازیابی مالک",
        "restoreConfirmation": "آیا می‌خواهید این مالک را بازیابی کنید؟",
        "restoreConfirmButton": "بله، بازیابی شود!",
        "units": "واحدها",
        "occupied": "اشغال شده",
        "maintenance": "تعمیر و نگهداری",
        "messages": {
          "loading": "در حال بارگذاری اطلاعات مالک...",
          "saving": "در حال ذخیره مالک...",
          "updating": "در حال به‌روزرسانی مالک...",
          "deleting": "در حال حذف مالک...",
          "deleteWait": "لطفاً صبر کنید در حال حذف مالک...",
          "saveError": "خطا در ذخیره مالک",
          "updateSuccess": "مالک با موفقیت به‌روزرسانی شد",
          "createSuccess": "مالک با موفقیت ایجاد شد",
          "deleteSuccess": "مالک با موفقیت حذف شد",
          "editError": "خطا در ویرایش مالک",
          "fetchError": "خطا در دریافت اطلاعات مالک",
          "deleteFail": "خطا در حذف مالک",
          "deleteError": "خطا در حذف مالک",
          "restoreSuccess": "مالک با موفقیت بازیابی شد",
          "restoreFail": "خطا در بازیابی مالک",
            "saveSuccess": "مالک با موفقیت ذخیره شد",
            "updateError": "خطا در به‌روزرسانی مالک"
        },
        "form": {
          "building": "ساختمان",
          "description": "توضیحات",
          "selectBuilding": "ساختمان را انتخاب کنید",
          "buildingRequired": "لطفاً یک ساختمان انتخاب کنید",
          "descriptionPlaceholder": "توضیحات مالک را وارد کنید (اختیاری)"
        }
    }
};